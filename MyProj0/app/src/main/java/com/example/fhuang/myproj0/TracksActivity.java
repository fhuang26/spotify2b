...
public class TracksActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*
        if (savedInstanceState == null && ArtistPhotosC.trackFrag == null) {
            Intent i = getIntent();
            if (i != null) {
                String val = i.getStringExtra("replay_track__notification");
                if (val != null) {
                    i.removeExtra("replay_track__notification");
                    populate_TrackFragment(true);
                } else {
                    populate_TrackFragment(false);
                }
            } else {
                populate_TrackFragment(false);
            }
